...
class CustomerService:
    ...
    async def auto_restore_suspended_customers() -> List[Customer]:
        ...
        return restored_customers# backend/app/services/customer_service.py
from typing import Optional, List
from uuid import UUID
from datetime import datetime
from app.models.customer_model import Customer
from app.schemas.customer_schema import CustomerCreate, CustomerUpdate, CustomerSearch
from beanie import PydanticObjectId
from beanie.operators import RegEx, Or, And
import re
